...
export const About = () => {
  ...
  return (
	...
	<div id="profile" className="w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-75 mx-6 lg:mx-0">
		...
		<div className="p-4 md:p-12 text-center lg:text-left">
			...
			<h1 className="text-3xl font-bold pt-8 lg:pt-0">Singupalli Kartik</h1>
 ...
 My interests lie in web and app development, and I enjoy writing C++ code while still having a working knowledge of other programming languages.
			...
			<div className="pt-12 pb-8">
                <a href="https://www.linkedin.com/in/singupalli-kartik/">
...
<div className="mt-6 pb-16 lg:pb-0 w-4/5 lg:w-full mx-auto flex flex-wrap items-center justify-between">
	...
	<div className="w-full lg:w-2/5">
		<img src="https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=3087&q=80" className="rounded-none lg:rounded-lg shadow-2xl hidden lg:block"/>
